  ...
  return (
    <ThemedView style={styles.container}>
      <ThemedView style={styles.headerRow}>
        ...
        <ThemedText type="title" style={styles.heading}>Select Brand</ThemedText>
      </ThemedView>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <Pressable
            ...
            onPress={() => router.push({ pathname: '/(onboarding)/select-model', params: { brandId: item.id, brandName: item.name } })}
          >
